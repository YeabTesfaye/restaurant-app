    ...
    <header className='fixed z-50 w-screen  p-3 px-4 md:p-6 md:px-16'>
        ...
        <div className='hidden md:flex w-full h-full items-center justify-between'>
            <Link to={'/'} className='flex items-center gap-2'>
                ...
                <p className='text-x1 text-headingColor font-bold'>City</p>
            </Link>
              ...
              className='w-10 min-w-[40px] min-h-[40px] drop-shadow-xl
               ...
               />
               {
                isMenu&&(
                  ...
                  {
                    user&&user.email === 'tesfayeyeabsra446@gmail.com' &&(
                    <Link to={'/createItem'}>
                  ...
                  <p className='px-4 py-2 flex items-center gap-3 cursor-pointer
                   hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base'>Logout <MdLogout /></p>
               </motion.div>
                )
               }
             </div>
             ...
             <motion.img whileTap={{scale:0.6}} 
              ...
              className='w-10 min-w-[40px] min-h-[40px] drop-shadow-xl
               ...
               />
               {
                ...
                <li className='text-base text-textColor hover:text-headingColor duration-100 transition-all 
                ease-in-out cursor-pointer px-4 py-2'>Menu</li>
                <li className='text-base text-textColor hover:text-headingColor duration-100 
                ...
                transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2  '>Service</li>
                  ...
                  <p className='m-2 p-2 rounded-md shadow-md flex justify-center  items-center gap-3 cursor-pointer
                   hover:bg-gray-100  transition-all duration-100 ease-in-out
                    text-textColor text-base :hover bg-gray-300'
                    onClick={logout}
                    >Logout <MdLogout /></p>
               </motion.div>
                )
